...
public abstract class BlockTankBase
  ...
  protected static final AxisAlignedBB AABB_NORTH = AABBHelper.create(4, 8, 2, 16, 16, 14);
  protected static final AxisAlignedBB AABB_EAST = AABBHelper.create(2, 8, 4, 14, 16, 16);
  protected static final AxisAlignedBB AABB_SOUTH = AABBHelper.create(0, 8, 2, 12, 16, 14);
  protected static final AxisAlignedBB AABB_WEST = AABBHelper.create(2, 8, 0, 14, 16, 12);
