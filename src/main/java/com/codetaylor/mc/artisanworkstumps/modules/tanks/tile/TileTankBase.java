...
public abstract class TileTankBase
  ...
  public TileTankBase() {
    ...
    super(ModuleTanks.TILE_DATA_SERVICE);
        ...
        if (resource != null) {
          ...
          if (fluid.getTemperature(resource) >= this.tile.getHotFluidTemperature()) {
            ...
            if (!world.isRemote) {
              ...
              ModuleTanks.PACKET_SERVICE.sendToAllAround(new SCPacketParticleCombust(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, 0.5, 0.5, 0.5), this.tile);
            }
